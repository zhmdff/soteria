    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col flex-1 ml-sidebar-width">
        ...
        <main className="pt-16 min-h-screen p-gutter-lg flex flex-col gap-stack-md">
          <div className="mt-8">
            <h1 className="font-headline-lg text-headline-lg text-on-surface text-4xl">İqlim Trendləri</h1>
          ...
          <div className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="flex gap-2">
                <span className="text-[10px] bg-red-500/10 text-red-500 px-2 py-1 rounded-full uppercase">ERA5 Model</span>
                <span className="text-[10px] bg-primary/10 text-primary px-2 py-1 rounded-full uppercase">Proqnoz</span>
              </div>
            </div>
