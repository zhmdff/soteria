    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col flex-1 ml-sidebar-width">
        ...
        <main className="pt-16 min-h-screen p-gutter-lg flex flex-col gap-stack-md">
          <div className="mt-8">
            <h1 className="font-headline-lg text-headline-lg text-on-surface text-4xl">Hava Keyfiyyəti Monitorinqi</h1>
            <p className="font-body-md text-on-surface-variant text-lg">Bakı və Abşeron yarımadası üçün canlı analiz</p>
          </div>
