  ...
  return (
    <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-xl p-6 shadow-sm flex flex-col gap-6">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center">
        <div className="flex-1 space-y-4">
          {activeMetric === "level" ? (
            <>
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed">Xəzər dənizinin orta səviyyəsi son 4 ildə təxminən 75 sm aşağı düşüb. Bu, ekosistem və dəniz nəqliyyatı üçün kritik həddir.</p>
            ...
            <>
              ...
              <p className="text-sm text-on-surface-variant leading-relaxed">Bəzi ərazilərdə (xüsusilə şimal-şərq) sahil xətti dənizin içərisinə doğru 1 kilometrdən çox geri çəkilib.</p>
        ...
        <div className="w-full md:w-48 h-48 bg-surface-container rounded-xl flex items-center justify-center relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <span className="text-[10px] text-primary absolute top-28">Cari Səviyyə</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-primary/5 rounded-lg border border-primary/10 flex gap-3 items-start">
        ...
        <p className="text-[11px] text-on-surface-variant leading-normal">Məlumatlar NASA Sentinel-6 və yerüstü hidrometeoroloji stansiyaların arxivlərinə əsasən hesablanıb.</p>
      </div>
    </div>
  );
}
