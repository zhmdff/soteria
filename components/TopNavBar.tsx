...
export default function TopNavBar() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-sidebar-width h-16 border-b border-outline-variant bg-surface-container-lowest/80 backdrop-blur-md z-[2000] flex justify-between items-center px-4 md:px-8">
